...
<div class="container">
    ...
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-3">
                <span style="color: #2aabd2;font-size: 30px;font-weight: bolder;">相关新闻</span>
            </div>
            <%-- 搜索框  --%>
            <div class="col-md-9">
        ...
        <div class="row">
            <table class="table table-hover" id="topicNewsTable">
                ...
                <c:forEach items="${plainNews}" var="news">
                    <tr>
                        <td>
                            <span style="margin-left: 10px;font-size: 24px">${news.ntitle}</span><br><br><br><br><br>
                ...
                <c:forEach items="${pictureNews}" var="temp">
                    <tr>
                        <td>
                            <span style="margin-left: 10px;font-size: 24px">${temp.ptitle}</span><br><br><br><br><br>
                            <div class="col-md-6" style="font-size: 15px">
